...
async function obtenerFavoritos(){
    msct = await fetch("http://localhost:3000/favoritas",{
    method: "GET",
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="botones_likes" style="padding-left: 60px; padding-bottom: 20px;">
                    <button id="btn_superlike" type="button" class="btn btn-info btn-circle btn-xl btn_superlike" title="Quitar de favoritos"><i class="fa fa-minus-circle"></i>
                    </button>
